...
if ($conn->connect_error) {
    ...
    $sql_stock = "SELECT COUNT(*) FROM Estoque WHERE quantidade < 10";
    $result_stock = $conn->query($sql_stock);

    if ($result_stock) {
        $row_stock = $result_stock->fetch_row();
        $lowStockCount = $row_stock[0];
    } else {
        error_log("Query de estoque baixo falhou: " . $conn->error);
    }

    $sql_so = "SELECT COUNT(*) FROM servicos WHERE situacao = 'Em andamento'";
    ...
    if ($result_so) {
        ...
        error_log("Query de O.S. em andamento falhou: " . $conn->error);
    }
...
<body class="transition-colors duration-300">
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-card rounded-xl shadow-md p-6 flex flex-col items-center justify-center text-center transition-colors duration-300">
                        ...
                        <p id="os-count" class="text-4xl font-bold text-primary-blue mt-2"><?php echo htmlspecialchars($SOCount); ?></p>
                    </div>
                    <div class="bg-card rounded-xl shadow-md p-6 flex flex-col items-center justify-center text-center transition-colors duration-300">
                ...
                <div class="bg-card rounded-xl shadow-md p-6 transition-colors duration-300">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <a href="Servicos.php" class="flex-1 min-w-[200px] px-6 py-4 rounded-xl font-medium transition duration-300 text-center text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            document.getElementById('revenue-amount').textContent = `R$ --`;
